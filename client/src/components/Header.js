  ...
  return (
    <div className="border w-main flex justify-between h-[110px] py-[35px]">
      ...
      <div className="flex text-[13px] ">
        <div className="flex flex-col px-6 border items-center">
        ...
        <div className="flex items-center justify-center gap-2 px-6 border">
          <BsHandbagFill color="red" />
          <span>0 item(s)</span>
        </div>
        <div className="flex items-center justify-center px-6 border ">
